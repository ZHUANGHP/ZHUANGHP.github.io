...
<div class="pub-overview">
  <h2>代表性学术成果</h2>
  <p>
    这里汇总了实验室近年来在持续学习、大模型、具身智能、联邦学习与多模态理解等方向的代表性论文。此次页面同步做了视觉美化，并尽量为近期工作补上公开代码入口，使它既能作为完整论文列表，也更适合作为实验室成果展示页。
  </p>
</div>
